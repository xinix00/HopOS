...
| --- | --- | --- | --- | --- | --- | --- |
| QEMU virt | ARM WFE/event stream; shared switch path | **N/A:** TCG never sleeps in WFE, so no kick is needed; the EDK2 machine carries the generic GICv3 SGI kick of the UEFI layer | WFE sleeper; TCG is not a power measurement | **Wired:** virtio SPI, GICv3; 10 ms fallback check | N/A for physical frequency control | N/A in this profile |
