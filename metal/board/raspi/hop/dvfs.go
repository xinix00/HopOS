...
// StartDVFS start het Pi-klokbeleid (docs/plan-p2b-soak.md): klok volgt idle
...
// mailbox-basis als enige verschil — dat is nu de parameter. TickHz =
// CNTFRQ/65536 (het event-stream-tempo van de idle-teller, metal/cpu/idle);
// Verbose logt elke flank (soak-diagnose).
