...
// BCM2712 zelf — níét achter de RP1 — en is daarmee naast HDMI het tweede
// blinde levensteken zolang de debug-UART geen kabel heeft (docs/rpi5.md).
// Bron: bcm2712-rpi-5-b.dtb — leds/led-act: gpios = <&gio_aon 9 ACTIVE_LOW>,
...
const (
	...
	actLEDBit = uint32(1) << 9 // pin 9, active-low
)
...
// LED zet de groene ACT-LED aan of uit (active-low: aan = 0 schrijven).
func LED(on bool) {
