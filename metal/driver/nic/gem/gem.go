...
// zelfde vorm als metal/driver/nic/virtionet, en net als die driver een
...
// zie metal/driver/nic/mdio (zelfde PHY, zelfde clause-22-scan).
func (n *Net) PHYScan() (addr int, id1, id2 uint16, found bool) {
	return mdio.Scan(n)
}

// AutoNeg start autonegotiatie op de PHY en wacht op een link; geeft
// (snelheid in Mbps, full-duplex). Gedeeld met genet via metal/driver/nic/mdio.
