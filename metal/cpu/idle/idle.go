...
func wakeAt(pollUntil int64) uint64 {
	...
	// Geklemd: semasleep zonder time-out geeft MaxInt64, en d×Hz loopt dan
	// over tot een willekeurige wektijd (gemeten: negatieve/vroege wektijden
	// op een SMP-app). Een uur is "nooit" genoeg — een kick komt eerder.
